...
<body><center>
    ...
    <!-- Start Top Bar -->
    <div class="top-bar" style="background-color: #1C7947; border-bottom: 5px solid #3A6351;" >
      <div class="top-bar-left">
        <ul class="menu"  style="background-color: #1C7947">
          <li class="menu-text" style="color:white;">
            ...
            <?php
                ...
                if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
                    ...
                    include_once 'dbConnection.php';
                    echo 'Hello Admin, ' . $username . ' <i class="fa fa-check-circle"></i> ';
                }
            ?></li>
          <li><li <?php
                if (@$_GET['q'] == 0)
                    echo 'class="active"';
                ?> ><a href="admindash.php?q=0" style="color:white;">&nbsp;Home</a></li></li>

                <li <?php
                if (@$_GET['q'] == 1)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=1" style="color:white;">&nbsp; Student Records</a></li>


                <li <?php
                if (@$_GET['q'] == 9)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=9" style="color:white;">&nbsp;Teacher List</a></li>
               ...
               <li <?php
                if (@$_GET['q'] == 6)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=6" style="color:white;">&nbsp; Reports</a></li> 

                <li <?php
                if (@$_GET['q'] == 2)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=2" style="color:white;">&nbsp;Leaderboards</a></li>

                <li <?php
                if (@$_GET['q'] == 4)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=4" style="color:white;">&nbsp;Add Quiz</a></li>

                <li <?php
                if (@$_GET['q'] == 5)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=5" style="color:white;">&nbsp; Remove Quiz</a></li>
                
                <li <?php
                if (@$_GET['q'] == 7)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=7" style="color:white;">&nbsp;Add Teacher</a></li>

                <li <?php
                if (@$_GET['q'] == 8)
                    echo 'class="active"';
                ?>><a href="admindash.php?q=8" style="color:white;">&nbsp;Add Student</a></li>
...
<tr><td style="vertical-align:middle; color: #000;"><b>#</b></td><td style="vertical-align:middle; color: #000"><b><i class="fa fa-user"></i> Name</b></td><td style="vertical-align:middle; color: #000;"><b> <i class="fa fa-question-circle"></i> Total question</b></td><td style="vertical-align:middle; color: #000;"><b><i class="fa fa-check-circle"></i> Marks</b></td><td style="vertical-align:middle; color: #000;"><b><i class="fa fa-clock-o"></i> Time limit</b></td><td style="vertical-align:middle; color: #000;"><b> <i class="fa fa-eye"></i> Status</b></td><td style="vertical-align:middle; color: #000;"><b><i class="fa fa-refresh"></i> Action</b></td></tr>';
  ...
  <td style="vertical-align:middle"><b><a href="update.php?eeidquiz=' . $eid . '" class="btn logb" style="color:#FFFFFF;background:#2ecc71;font-size:12px;padding:5px; border-bottom-left-radius: 6px;
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Student </b></td><td style="vertical-align:middle"><b></b></td></tr>';
    ...
    if($show == 1 && $total==1){
        ...
        $i = 1;
        while($i<=$total){
            echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:typo;font-weight:bold" href="admindash.php?q=2&show='.$i.'">&nbsp;'.$i.'&nbsp;</a></td>';
            $i++;
        }
        echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:typo;font-weight:bold" href="admindash.php?q=2&show='.($show+1).'">&nbsp;>>&nbsp;</a></td>';
    }
...
if (@$_GET['q'] == 9) {
  $result = mysqli_query($con, "SELECT * FROM admin") or die('Error');
    echo '<div class="panel"><table class="table table-striped title1">
    <tr><td style="vertical-align:middle"><b>Teachers list </b></td><td style="vertical-align:middle"></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $username = $row['username'];
        ...
        <tr><td style="vertical-align:middle">' . $username . '</td><td style="vertical-align:middle"></td></tr>
         ';
    }
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Date</b></td><td style="vertical-align:middle"><b>Time</b></td><td style="vertical-align:middle"><b>By</b></td><td style="vertical-align:middle"></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<td style="vertical-align:middle"><a title="Click to open feedback" href="admindash.php?q=3&fid=' . $id . '">' . $subject . '</a></td><td style="vertical-align:middle">' . $username1 . '</td><td style="vertical-align:middle">' . $date . '</td><td style="vertical-align:middle">' . $time . '</td><td style="vertical-align:middle">' . $name . '</td>
  <td style="vertical-align:middle"><a title="Open Feedback" href="admindash.php?q=3&fid=' . $id . '"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    ...
    <div class="form-group">
      ...
      <div class="col-md-12"> 
        <input  type="submit" style="text-align:center;  background-color: #4CAF50; /* Green */
        border: none;
        color: white;
        padding: 15px 32px;
        text-align: center;
        ...
        border-top-right-radius: 30px;" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
      </div>
    </div>
    <br><br>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
  ...
  border-bottom-right-radius:6px; border-top-left-radius: 6px; border-top-right-radius: 6px;">&nbsp;<b>Remove</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
