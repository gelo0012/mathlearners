...
if($_SERVER["REQUEST_METHOD"] == "POST" ){
    ...
    if(empty($_POST["ending"])){
        ...
        $ending= $_POST["ending"];
                ...
                $query = mysqli_query($connections, "INSERT INTO lesson (headline,context,content,ending) VALUES ('$headline', '$context', '$content', '$ending')");
...
$view_query = mysqli_query($connections, "SELECT * FROM lesson");
...
while($row = mysqli_fetch_assoc($view_query)){
    ...
    <td> $content</td>
    <td> $ending</td>
    <td><a href='edit.php?id=$id'  style='color: green'><b>Edit</b></a>
    &nbsp;
    <a href='delete.php?id=$id' style='color: red'><b>Remove</b></a>
    </td>
    </tr>";
